	...
	; Compiler options:
	;
	; --asmlist --summary=default --output=intel -I.\ \
	; -IC:\Program Files (x86)\YSPRING\MDT-IDE\lib\header -oYS8384 \
	; --opt=default --ram=default --runtime=default -D__DEBUG=1 \
	; --chip=16F688 --warnformat=%f:%l: warning %n : %s \
	; --errformat=%f:%l: error %n : %s Touch.c Uart.c User.c YS8384XX.C \
	; YS8384V1_1.lpp
	;
